    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#deleteActivityBtn").click(function () {
                ...
                var ids = new Array();
                $.each(chkedIds, function (index, item) {
        ...
        function fun() {
            $("input[name='subBox']").click(function () {
                if ($("input[name='subBox']").size() == $("input[name='subBox']:checked").size()) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(data.activityList, function (index, obj) {
                        ...
                        htmlStr += "<td><input name = \"subBox\" type=\"checkbox\"  value=\"" + obj.id + "\"/></td>";
                    ...
                    $("#demo_pag1").bs_pagination({
                        ...
                        showGoToPage: false,//是否显示"跳转到第几页"
                        showRowsPerPage: false,//是否显示"每页显示条数"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="height: 350px;">
                <div style="position: relative;top: 20px; left: 50px;">
                    请选择要上传的文件：
                    <small style="color: gray;">[仅支持.xls格式]</small>
                </div>
