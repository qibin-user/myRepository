		...
		<div style="width: 100%; position: absolute;top: 5px; left: 10px;">
			...
			<div style="position: relative;top: 50px;">
				<table class="table table-hover">
					...
					<tbody>
					<c:forEach items="${clueList}" var="clue" varStatus="sum">
						...
						<c:if test="${sum.count%2!=0}">
							...
							<td><input type="checkbox" /></td>
							<td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href='workbench/clue/detailClue.do?id=${clue.id}';">${clue.fullName}</a></td>
							<td>${clue.company}</td>
							<td>${clue.phone}</td>
							<td>${clue.mphone}</td>
							<td>${clue.source}</td>
